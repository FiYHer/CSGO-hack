...
// 2020-12-19 07:24:38.611537100 UTC

namespace hazedumper {
namespace netvars {
constexpr ::std::ptrdiff_t m_szUpdate = 0x2020.12.19;
...
constexpr ::std::ptrdiff_t m_iViewModelIndex = 0x3240;
...
constexpr ::std::ptrdiff_t ClientCmd_Unrestricted = 0xB1550;
...
constexpr ::std::ptrdiff_t dwSensitivity = 0xD9F16C;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xD9F140;
...
constexpr ::std::ptrdiff_t fakeLevel = 0x51F133C;
constexpr ::std::ptrdiff_t find_hud_element = 0x30FAEE80;
