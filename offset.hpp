...
// 2021-01-08 12:39:43.259194600 UTC

namespace hazedumper {
namespace netvars {
constexpr ::std::ptrdiff_t m_szUpdate = 0x2021.1.8;
...
constexpr ::std::ptrdiff_t fakeLevel = 0x51F457C;
constexpr ::std::ptrdiff_t find_hud_element = 0x2BD3EED0;
