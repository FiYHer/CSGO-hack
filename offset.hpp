...
// 2021-01-30 03:59:21.035226500 UTC

namespace hazedumper {
namespace netvars {
constexpr ::std::ptrdiff_t m_szUpdate = 0x2021.1.30;
...
constexpr ::std::ptrdiff_t fakeLevel = 0x51F368C;
constexpr ::std::ptrdiff_t find_hud_element = 0x2E42E320;
