...
constexpr ::std::string m_szShowMessage = [2020.8.30];
...
constexpr ptrdiff_t dwEntityList = 0x4D5442C;
constexpr ptrdiff_t dwForceAttack = 0x3185984;
constexpr ptrdiff_t dwForceAttack2 = 0x3185990;
constexpr ptrdiff_t dwForceBackward = 0x31859D8;
constexpr ptrdiff_t dwForceForward = 0x31859B4;
constexpr ptrdiff_t dwForceJump = 0x51FE044;
constexpr ptrdiff_t dwForceLeft = 0x31859CC;
constexpr ptrdiff_t dwForceRight = 0x31859F0;
constexpr ptrdiff_t dwGameDir = 0x6285F8;
constexpr ptrdiff_t dwGameRulesProxy = 0x527133C;
constexpr ptrdiff_t dwGetAllClasses = 0xD6623C;
constexpr ptrdiff_t dwGlobalVars = 0x589AD8;
constexpr ptrdiff_t dwGlowObjectManager = 0x529C208;
constexpr ptrdiff_t dwInput = 0x51A5A08;
constexpr ptrdiff_t dwInterfaceLinkList = 0x908964;
constexpr ptrdiff_t dwLocalPlayer = 0xD3FC5C;
constexpr ptrdiff_t dwMouseEnable = 0xD45800;
constexpr ptrdiff_t dwMouseEnablePtr = 0xD457D0;
constexpr ptrdiff_t dwPlayerResource = 0x3183D10;
constexpr ptrdiff_t dwRadarBase = 0x518919C;
constexpr ptrdiff_t dwSensitivity = 0xD56BBC;
constexpr ptrdiff_t dwSensitivityPtr = 0xD56B90;
constexpr ptrdiff_t dwSetClanTag = 0x89E50;
constexpr ptrdiff_t dwViewMatrix = 0x4D45D74;
constexpr ptrdiff_t dwWeaponTable = 0x51A64C8;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xCA450002;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD4A700;
constexpr ptrdiff_t dwbSendPackets = 0xD418A;
constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA7030;
constexpr ptrdiff_t m_pStudioHdr = 0x294C;
constexpr ptrdiff_t m_yawClassPtr = 0xD45460;
constexpr ptrdiff_t m_pitchClassPtr = 0x5189438;
...
constexpr ptrdiff_t set_abs_angles = 0x1D7C50;
constexpr ptrdiff_t set_abs_origin = 0x1D7A90;
constexpr ptrdiff_t is_c4_owner = 0x3B0910;
constexpr ptrdiff_t force_update_spectator_glow = 0x3A3E82;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x35E64F10;
