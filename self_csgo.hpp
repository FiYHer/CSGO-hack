...
namespace offsets
{
constexpr ::std::string m_szShowMessage = [2020.10.6];
constexpr ::std::ptrdiff_t m_fFirstHook = 0xB03B0;
constexpr ::std::ptrdiff_t m_fSecondHook = 0xB03F0;
	
//signatures
constexpr ptrdiff_t fakePrime = 0x5AF34F;
constexpr ptrdiff_t fakeLevel = 0x51A198C;
constexpr ptrdiff_t fakeRank = 0xC4690001;
...
constexpr ptrdiff_t dwEntityList = 0x4D5022C;
constexpr ptrdiff_t dwForceAttack = 0x3181790;
constexpr ptrdiff_t dwForceAttack2 = 0x318179C;
constexpr ptrdiff_t dwForceBackward = 0x31817E4;
constexpr ptrdiff_t dwForceForward = 0x31817F0;
constexpr ptrdiff_t dwForceJump = 0x51F9E44;
constexpr ptrdiff_t dwForceLeft = 0x318176C;
constexpr ptrdiff_t dwForceRight = 0x3181760;
constexpr ptrdiff_t dwGameDir = 0x6285F8;
constexpr ptrdiff_t dwGameRulesProxy = 0x526D144;
constexpr ptrdiff_t dwGetAllClasses = 0xD6223C;
constexpr ptrdiff_t dwGlobalVars = 0x589AD8;
constexpr ptrdiff_t dwGlowObjectManager = 0x5298078;
constexpr ptrdiff_t dwInput = 0x51A1808;
constexpr ptrdiff_t dwInterfaceLinkList = 0x905904;
constexpr ptrdiff_t dwLocalPlayer = 0xD3BC5C;
constexpr ptrdiff_t dwMouseEnable = 0xD41800;
constexpr ptrdiff_t dwMouseEnablePtr = 0xD417D0;
constexpr ptrdiff_t dwPlayerResource = 0x317FB10;
constexpr ptrdiff_t dwRadarBase = 0x5184F9C;
constexpr ptrdiff_t dwSensitivity = 0xD52BBC;
constexpr ptrdiff_t dwSensitivityPtr = 0xD52B90;
constexpr ptrdiff_t dwSetClanTag = 0x89E20;
constexpr ptrdiff_t dwViewMatrix = 0x4D41B74;
constexpr ptrdiff_t dwWeaponTable = 0x51A22C8;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xC4690002;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD46700;
constexpr ptrdiff_t dwbSendPackets = 0xD41DA;
constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA7030;
constexpr ptrdiff_t m_pStudioHdr = 0x294C;
constexpr ptrdiff_t m_yawClassPtr = 0xD41460;
constexpr ptrdiff_t m_pitchClassPtr = 0x5185238;
...
constexpr ptrdiff_t set_abs_angles = 0x1D4590;
constexpr ptrdiff_t set_abs_origin = 0x1D43D0;
constexpr ptrdiff_t is_c4_owner = 0x3AD1E0;
constexpr ptrdiff_t force_update_spectator_glow = 0x3A0752;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x3BC217D0;
